...
JiraExecute::usage = "JiraExecute[apiName, properties] executes a query \
...
JiraExecute[apiName_String, properties_Association: <||>, OptionsPattern[]] := Module[
    ...
    result = Import["!curl "
        <> URLBuild[{host, "jira", "rest", "api", "2", apiName}] <> " "
        <> loginInfo <> " "
        <> "-X " <> method <> " "
